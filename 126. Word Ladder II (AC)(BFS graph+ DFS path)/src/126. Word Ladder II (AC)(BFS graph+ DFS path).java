 ...
 * 1. Using a MAP to store the min ladder of each word, or use a SET to store the words visited
 ...
 * 2. Use Character iteration to find all possible paths. Do not compare one word to all the other words
 *    and check if they only differ by one character.
 * 3. One word is allowed to be inserted into the queue only ONCE. See my comments.
 * 4. DataStructure:
 *    List<List<String>> res, Set<String> wordList.
 *    Map<String, List<String>> graph (BFS),  Map<String, Integer> ladder(Dijisktra search), Queue<String> queue;
 */
class Solution1 {
    ...
    public List<List<String>> findLadders(String start, String end, List<String> wordList) {
        ...
        //First in, First out.-> Deque;(ArrayDeque)
            ...
            for (int i = 0; i < word.length(); i++) {
                ...
                for (char ch = 'a'; ch <= 'z'; ch++) {
                    ...
                    if (ladder.containsKey(new_word)) {
                        ...
                        } else ;//(step = ladder.get(new_word)) {do Nothing.}
    ...
    public static void main(String[] args) {
        Solution1 Launcher = new Solution1();
        Launcher.start1();
    }
